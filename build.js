...
fs.writeFileSync(path.join(DIST, 'switch.html'), swHtml);
...
fs.writeFileSync(path.join(DIST, 'sw.js'), [
  ...
  "const ASSETS = ['./', './index.html', './time.html', './disney.html', './food.html', './grow.html', './home.html', './switch.html', './assets/tokens.css', './manifest.json', './icon-192.png', './icon-512.png'];",
